			...
			<form action="./update" method="POST" enctype="multipart/form-data"
					...
					<div class="input-group mb-3">
						<c:forEach items="${dto.categoryDTO }" var="category">
							<input type="text" class="form-control"
								...
								data-category-num="${category.categoryNum }" readonly="readonly"
								name="categoryDTOs">
				...
				<div id="optionList">
					<div class="mb-3" id=option1>
						<label for="option1" class="form-label">옵션1 이름</label> <input
							type="text" class="form-control" name="option1"
							value="${dto.option1 }">
					</div>
					<c:if test="${not empty dto.option2 }">
						<div class="mb-3" id=option2>
							<label for="option2" class="form-label">옵션2 이름</label> <input
					...
					<c:if test="${not empty dto.option3 }">
						<div class="mb-3" id=option3>
							<label for="option3" class="form-label">옵션3 이름</label> <input
					...
					<c:if test="${not empty dto.option4 }">
						<div class="mb-3" id=option4>
							<label for="option4" class="form-label">옵션4 이름</label> <input
				...
				<div class="mb-3" id="fileList">
					<div>
						<c:if test="${not empty dto.healthMachineImgDTOs}">
				...
				<br>
				<div class="mb-3" id="realMachineList"></div>
