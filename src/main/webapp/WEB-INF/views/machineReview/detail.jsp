...
<div class="container px-4 px-lg-5">
	<div class="row gx-4 gx-lg-5 align-items-center my-5">
		<div class="col-lg-5">
			...
			<c:forEach items="${dto.healthMachineDTOs}" var="healthMachine">	
				<h6><strong>${healthMachine.machineName}<strong></h6>
			</c:forEach>
			<p>${dto.contents}</p>
			<div class="col-lg-5">
			...
			<div class="my-3">
				<form action="./update" id="frm" method="post">
					...
					<c:if test="${dto.writer eq sessionMember.id}">
						...
						<button class="btn btn-primary reviewUpdate" data-comment-num="${dto.machineNum}" data-bs-toggle="modal" data-bs-target="#contentsModal">리뷰수정</button>
