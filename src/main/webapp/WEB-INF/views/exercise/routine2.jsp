        ...
        <tbody>
          <c:forEach items="${routine}" var="dto" varStatus="status">
            <tr class="calendar-row">
              <td class="calendar-day ${dto.days}"><div>${dto.day}</div><div class="img rounded-circle mb-2" style="background-image: url(${dto.thumbNail});"></div><a href="./video?num=${dto.num}"><strong>${dto.title}</strong></a></td>
            </tr>
          </c:forEach>
        </tbody>
      </table>
