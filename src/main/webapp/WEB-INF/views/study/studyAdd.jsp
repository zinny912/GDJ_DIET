...
<div class="container-fluid essbox">
	...
	<div class="row justify-content-center">
		<form class="col-md-7" action="./studyAdd" method="post" enctype="multipart/form-data" id="frm">
			
			<div class="mb-3">
				<label for="studyName" class="form-label">스터디 이름</label> 
				<input type="text" name="studyName" class="form-control essential" id="studyName" placeholder="온라인 스터디 입력">
			</div>
	
			<div class="mb-3">
				<label for="studyCost" class="form-label">스터디 가격</label>
				<input type="text" name="studyCost" class="form-control essential" id="studyCost" placeholder="스터디 가격 입력">
			</div>
			...
			<div class="mb-3">
				...
				<input type="text" name="studyStock" class="form-control essential" id="studyStock" placeholder="스터디 재고 입력">
			</div>
