							...
							<c:forEach items="${dto.healthMachineDTO.healthMachineImgDTOs}"
								...
								<tr class="cart__list__machine__detail">
									...
									<td style="width: 13%;"><span class="price machineval"
										style="font-size: 15px;" id="count">${dto.count}</span></td>
								</tr>
 ...
 --%>
					...
					<div class="col-md-6">
						<div class="bordered my-5">
							...
							<p class="info" id="totalCost" data-totalCost="${totalCost }">
							<input type="hidden" value="${totalCost }" name="price">
			...
			<div class="cart__mainbtns">
				<button class="cart__bigorderbtn right btn btn-primary"
					type="button" onclick="checkPayment()">결제하기</button>
			</div>
		</div>
